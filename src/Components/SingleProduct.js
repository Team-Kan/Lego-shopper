...
const SingleProduct = () => {
  ...
  return (
    <div className="flex md:justify-center items-center">
      {product.id ? (
        <div className="flex flex-col md:m-10 md:items-center rounded-xl bg-gradient-to-t from-green-500 via-green-700 to-green-200 w-11/12 min-w-[600px]">
          ...
          <div className="flex m-10 shadow-lg shadow-black rounded-md">
            <div className="pl-2 border-r-2 border-white bg-[#3E363F] text-green-200 rounded-l-md">
              <h5>Description:</h5>
              <h6 className="w-48 h-48 md:w-72 lg:w-96">{product.description}</h6>
            </div>
